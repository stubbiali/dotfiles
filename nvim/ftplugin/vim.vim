" Vim filetype plugin
" Language: Vim
" Maintainer: Stefano Ubbiali <stefano.ubbiali@outlook.com>
" Original Maintainer: Bram Moolenaar <Bram@vim.org>
" Last Change: 19 Apr 2020
...
" Set 'formatoptions' to break lines,
" and do not insert the comment leader when hitting <CR> or using "o".
setlocal fo+=t fo+=crql fo-=o
